window.onload = function() {
    main();
    function main(){
        var error_massage = document.getElementById('demo');
        ...
        try {
            ...
            if(isNaN(step)) throw "error";
                ...
                error_massage.innerHTML = 'The generated arry is: ' + arr +', ';
                suminfo.innerHTML = 'The sum is: '+ total;
                binaryinfo.innerHTML = 'The binary of absolut element values are: ' + p + ', ' ;
            }
        }
        catch(err) {
